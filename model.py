...
class VGGBaseRD(nn.Module):
    """
    VGG base convolutions to produce lower-level feature maps.
    """

    def __init__(self):
        super(VGGBaseRD, self).__init__()
...
class VGGBaseRA(nn.Module):
    """
    VGG base convolutions to produce lower-level feature maps.
    """

    def __init__(self):
        super(VGGBaseRA, self).__init__()
...
class SSD300(nn.Module):
    ...
    def __init__(self, n_classes, signal_type='range_doppler'):
